...
- Columns with significant missing values, such as Wifi_&_Connectivity (83%) and Aircraft (48%), were dropped to ensure data reliability. Rows with null values in non essential columns were also removed.
